...
async def health_check() -> HealthResponse:
    ...
    backends = await asyncio.gather(
        _check_backend("llm (llama.cpp)", get_llm_backend().health(), "http://llama.cpp"),
        ...
        _check_backend("tts (fish_audio)", get_tts_backend().health(), "fish.audio"),
        _check_backend("bgm (ace_step)", get_bgm_backend().health(), "local"),
    )
